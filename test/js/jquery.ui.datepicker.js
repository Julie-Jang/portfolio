...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		currentText: "이번달", // Display text for current month link
...
$.extend(Datepicker.prototype, {
	...
	_attachDatepicker: function(target, settings) {
		...
		target.setAttribute("aria-labelledby", target.id + "-month-lbl");
		target.setAttribute("aria-haspopup", "grid");
	...
	_updateDatepicker: function(inst) {
		...
		inst.input.attr("aria-activedescendant", inst.id + "-" + inst.selectedDay);
	...
	_hideDatepicker: function(input) {
		...
		inst.input[0].setAttribute("aria-expanded", "false");
		inst.input[0].removeAttribute("aria-activedescendant");
		...
		for (row = 0; row < numMonths[0]; row++) {
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				calender += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + cornerClass + "'>" +
					...
					"</div><table class='ui-datepicker-calendar' role='grid'><caption>날짜선택기</caption><thead role='presentation'>" +
					"<tr role='row'>";
				thead = (showWeek ? "<th class='ui-datepicker-week-col' scope='col'>" + this._get(inst, "weekHeader") + "</th>" : "");
				for (dow = 0; dow < 7; dow++) { // days of the week
					day = (dow + firstDay) % 7;
					thead += "<th scope='col' role='columnheader' abbr='" + dayNames[day] + "' aria-label='" + dayNames[day] + "'" + ((dow + firstDay + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" +
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		var inMinYear, inMaxYear, month, years, thisYear, determineYear, year, endYear,
			...
			html = "<div class='ui-datepicker-title' id='" + (inst.id + "-month-lbl") + "'>",
			monthHtml = "";
		...
		if ( !inst.yearshtml ) {
			...
			if (secondary || !changeYear) {
				...
				inst.yearshtml += "<select title='연도 선택' class='ui-datepicker-year' data-handler='selectYear' data-event='change'>";
		...
		if (secondary || !changeMonth) {
			...
			monthHtml += "<select title='월 선택' class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";
